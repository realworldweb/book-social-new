...
/*svgs*/
import { Email, Facebook, Google } from '../svg/icons';
...
function Login() {
	...
	return (
		<form
			className='relative rounded-md flex flex-col mb-3 px-5 gap-5 items-center w-1/2 min-w-[260px] mx-auto mt-5 border border-slate-400/50 justify-around bg-white shadow-xl h-fit'
			onSubmit={signIn}
		>
